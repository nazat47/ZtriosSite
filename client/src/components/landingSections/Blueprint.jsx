    ...
    <>
        ...
        <div className="flex flex-col items-center justify-center text-center w-full xl:w-[85%]">
          ...
          <p className="text-[#7950f2de] text-lg sm:text-[25px] md:text-[30px] lg:text-[35px] xl:text-[40px] 2xl:text-[50px] font-bold relative">
            ...
            <img
              ...
              alt="circle"
              className="top-[85%] right-[-8%] absolute w-[80px] h-[15px] sm:h-full sm:w-full"
            />
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 2xl:gap-6 mt-8 sm:mt-10 xl:mt-14 relative">
            ...
            <div className="h-[350px] sm:h-[400px] rounded-lg p-4 bg-black text-white shadow-xl">
              <p className="flex flex-col text-lg md:text-[1.5vw] items-start leading-[140%]">
                Discover{" "}
                <span className="font-bold text-3xl md:text-[2.5vw]">Potential</span>
              </p>
              <img
                src={images?.iceberg}
                alt="iceberg"
            ...
            <div className="h-[350px] sm:h-[400px] rounded-lg bg-black text-white relative shadow-xl">
              ...
              />
              <p className="text1_gradient absolute top-6 ml-4 text-3xl sm:text-4xl md:text-[2.5vw] font-bold text-left leading-[40px]">
                Design Brilliance
              </p>
              <p className="absolute bottom-2 font-black text-black text-sm sm:text-lg md:text-md">
                Crafting tailored solutions that shine
              </p>
            </div>
            <div className="h-[350px] sm:h-[400px] rounded-lg p-4 bg-black text-white shadow-xl">
              <p className="text2_gradient flex flex-col text-2xl sm:text-3xl md:text-[2.5vw] items-start font-bold leading-[30px] mt-4">
      ...
      <div className="w-full flex flex-col gap-4 items-center justify-center mt-[80px] sm:mt-[120px] relative">
        ...
        <div className="text-center">
          <p className="text-[#925fffd9] font-semibold text-xs md:text-md xl:text-xl">Our Partners</p>
