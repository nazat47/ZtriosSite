...
const Collaborate = () => {
  return (
    <>
      <div className="w-full h-[100vh] md:h-full flex flex-col gap-4 items-center justify-center mt-[90px] sm:mt-[120px] p-4 md:p-6 bg-black rounded-2xl relative">
        <img
          src={images?.net2}
          alt="net"
        ...
        <div className="flex flex-col md:flex-row gap-4 lg:gap-7 w-full h-full">
          <div className="flex items-center justify-center bg-black text-gray-400 h-[50%] md:flex-1">
            <div className="w-[100%] xl:w-[80%] md:my-8">
              ...
              <form className="flex flex-col gap-2 xl:gap-4 w-full mt-3 md:mt-8">
                ...
                <textarea
                  ...
                  placeholder="Message"
                  rows={3}
                  className="p-3 w-full bg-[#0a0a0a] rounded-lg border border-gray-600 resize-none outline-gray-300 text-sm sm:text-md"
                />
                <button
                  type="submit"
